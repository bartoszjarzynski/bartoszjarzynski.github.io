...
function showAmountPrompt(type) {
    ...
    if (amount !== null && amount !== '') {
        ...
        if (type === 'deposit') {
            ...
            var currentSpendings = parseInt(document.getElementById('spendingsAmount').textContent);
            var newSpendings = currentSpendings + parsedAmount;
            document.getElementById('spendingsAmount').textContent = newSpendings + '$';
            // Update wallet amount
            var currentWallet = parseInt(document.getElementById('walletAmount').textContent);
            var newWallet = currentWallet - parsedAmount;
            document.getElementById('walletAmount').textContent = newWallet + '$';
            ...
            document.getElementById('spendingsLimitValue').textContent = 'Set limit is ' + spendingsLimit + '$';
        }
